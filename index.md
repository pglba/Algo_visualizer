...
<body>
	...
	<div class="row justify-content-md-center">
		...
		<div class="col-md-auto">
			<img style="margin-top: 10px;" src="icon.png" height="100px" width="120px">
		</div>
		...
		<div class=" col-md-auto sidebar" id="canvasFigureSidebar">
			<ul class="list-group list-group-horizontal-xl optionSize">
				...
				<a target="_blank" href="https://github.com/pglba/Algo_visualizer.git">More Details</a>
				</li>
